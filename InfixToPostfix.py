...
class InfixToPostfixConverter:
    ...
    def attempt_conversion(exp):
        ...
        for count, c in enumerate(exp): 
            ...
            if InfixToPostfixConverter.is_operand(c):
                last_connective = -1
                output.append(c)
            ...
            # Operator
            elif InfixToPostfixConverter.is_operator(c):
                ...
                while not stack.is_empty() and InfixToPostfixConverter.not_greater(c, stack): 
